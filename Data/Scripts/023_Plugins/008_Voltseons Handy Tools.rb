...
def vBreak()
  $PokemonBag.pbChangeItem(:TELEPORTDEVICEW,:BROKENTELEPORTDEVICEW)
  $PokemonBag.pbChangeItem(:TELEPORTDEVICEB,:BROKENTELEPORTDEVICEB)
  $PokemonBag.pbChangeItem(:TELEPORTDEVICEP,:BROKENTELEPORTDEVICEP)
end

def vFix()
  $PokemonBag.pbChangeItem(:BROKENTELEPORTDEVICEW,:TELEPORTDEVICEW)
  $PokemonBag.pbChangeItem(:BROKENTELEPORTDEVICEB,:TELEPORTDEVICEB)
  $PokemonBag.pbChangeItem(:BROKENTELEPORTDEVICEP,:TELEPORTDEVICEP)
end
################################################################################
#
# Alternate Methods
